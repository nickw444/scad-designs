// NBN NTD + six keystones, sized to pair with the 2/3U patch panel.

include <../device-mount.scad>

/* [Output] */
output_part = "assembled"; // Complete mount
...
keystone_rows = 2;
keystone_gap = 3;
keystone_row_gap = -2.5; // Overlap one wall thickness for a compact shared row wall
port_labels = false;
